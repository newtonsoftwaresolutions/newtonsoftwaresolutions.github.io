...
BEGIN
{
  ...
  $allow_empty_ref   = 1;
  $max_recipients    = 5;
#  $mailprog          = '/usr/sbin/sendmail -oi -t -f tim@newtonsoftware.net';
  $mailprog          = '/usr/sbin/sendmail -oi -t';
  $postmaster        = '';
  @referers          = ();
  @allow_mail_to     = qw(tim@newtonsoftware.net timn@bigfoot.com deborah.wylie@macunlimited.net jenharris@littleangels.onyxnet.co.uk pampark@littleangels.onyxnet.co.uk);
  @recipients        = ();
  %recipient_alias   = ();
